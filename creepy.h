...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(245, 34);
			this->label2->TabIndex = 13;
			this->label2->Text = L"CreepyLauncher v1.3";
			// 
			// fpscounter
			// 
			...
			this->fpscounter->Size = System::Drawing::Size(63, 34);
			this->fpscounter->TabIndex = 14;
			//this->fpscounter->Text = L"FPS: ";
			...
			this->selector->Location = System::Drawing::Point(430, 370);
			...
			this->Text = L"CreepyLauncher v1.3";
